...
const Player: React.FC<PlayerProps> = ({ videoSrc, posterSrc }) => {
          ...
          <div className={style.icon}>
            <div className={style.playButton} onClick={handlePlayClick}>
              ...
              <svg width="100" height="60" viewBox="0 0 100 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1 1 L85 1 L99 15 L99 59 L1 59 Z" stroke="white" strokeWidth="1" fill="none" />
      ...
      {showModal && (
        <div className={style.modalOverlay} onClick={handleCloseModal}>
          <div className={style.modalContent} onClick={handleModalVideoClick}>
            ...
            <video ref={modalVideoRef} className="modal-video" src={videoSrc} controls autoPlay />
          </div>
        </div>
      )}
    </>
