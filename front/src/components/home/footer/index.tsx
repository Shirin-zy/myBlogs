...
const Footer = () => {
  ...
  useEffect(() => {
    ...
    const updateTimer = () => {
      ...
      setRunningTime(
        `${days} 天 ${hours.toString().padStart(2, "0")} 小时 ${minutes.toString().padStart(2, "0")} 分 ${seconds.toString().padStart(2, "0")} 秒`,
      )
    }
    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        ...
        <div className={styles.topSection}>
          <div className={styles.copyright}>©2026 - {new Date().getFullYear()} By Shirin</div>
          <div className={styles.badgeLine}>
            <span className={styles.miniBadge}>记录美好</span>
          </div>
          <div className={styles.status}>本站居然运行了 {runningTime} ❤️</div>
        </div>
        ...
        <div className={styles.bottomSection}>
          <div className={styles.badges}>
            ...
            <div
              className={styles.badge}
              onClick={() => {
                window.open("https://github.com/Shirin-zy/myBlogs")
              }}
            >
