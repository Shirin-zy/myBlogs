...
function App() {
  ...
  const { loginWithPassword, loginWithCode, sendVerificationCode } =
    useAppStoreActions();
      ...
      <div className={styles.rightPanel}>
        <div className={styles.formContainer}>
          ...
          <div className={styles.loginModeToggle}>
            <button
              type="button"
              className={`${styles.modeBtn} ${loginMode === "password" ? styles.active : ""}`}
            ...
            <button
              type="button"
              className={`${styles.modeBtn} ${loginMode === "code" ? styles.active : ""}`}
          ...
          <form onSubmit={onSubmit}>
            ...
            <div className={styles.formGroup}>
              ...
              <div className={styles.inputWrapper}>
                <input
                  ...
                  placeholder="you@example.com（未注册账号将自动注册）"
                  autoComplete="off"
            ...
            {loginMode === "password" ? (
              ...
              <div className={styles.formGroup}>
                <label
                  htmlFor="verifyCode"
                  className={codeError ? styles.errorLabel : ""}
                >
                  验证码
                </label>
